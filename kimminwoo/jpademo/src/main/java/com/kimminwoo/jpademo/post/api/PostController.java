...
public class PostController {
    ...
    @PostMapping
    public ResponseEntity<PostResponseDto> create(@RequestBody PostRequests.Create body) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PostResponseDto> update(@PathVariable Long id, @RequestBody PostRequests.Update body) {
